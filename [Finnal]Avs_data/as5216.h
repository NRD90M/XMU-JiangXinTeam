/*
 * libavs - Public interface for Avantes spectrometer library
 *
...
#define     NR_DIGITAL_OUTPUTS              10
#define     NR_DIGITAL_INPUTS               3
#define     NTC1_ID                         0
#define     NTC2_ID                         1
#define     TEC_ID                          2
...
// Name       : AVS_GetComType
//
// Description: Returns the communication type
//
//    RS232 = 0
//    USB   = 1
//    ETH   = 2
...
#define ERR_INVALID_DEVICE_ID ERR_INVALID_PARAMETER  -4
